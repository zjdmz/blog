...
class Captcha(object):
    ...
    def gene_code(cls):
        ...
        bgcolor = (255, 255, 255)  # 背景颜色，默认为白色 RGB(Re,Green,Blue)

        r, g, b = random.randint(0, 185), random.randint(0, 185), random.randint(0, 185)
        fontcolor = (r, g, b)  # 随机字体颜色

        width, height = cls.size  # 图片宽和高
